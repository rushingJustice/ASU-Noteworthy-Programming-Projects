...
%---- Mass, stiffness, damping, length multipliers ----------------------*
      Mo = 5.0;                   % Mass scaling value
      Ko = 7;                  % Stiffness scaling value
      Xi = 0.02;                  % Damping ratio scaling value
...
%---- Forcing function parameters ---------------------------------------*      
      ...
      Fo2 = 1;                    % Amplitude of forcing function
...
%---- Initial displacement and velocity multipliers ---------------------*
      Xo = 0;                  % Initial displacement scale
      Vo = 1;                     % Initial velocity scale
